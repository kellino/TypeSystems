...
/* package gradualSecurity-0.1.0.0 */
#define VERSION_gradualSecurity "0.1.0.0"
#define MIN_VERSION_gradualSecurity(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package cmdargs-0.10.15 */
#define VERSION_cmdargs "0.10.15"
#define MIN_VERSION_cmdargs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  10 || \
  (major1) == 0 && (major2) == 10 && (minor) <= 15)
...
/* package repline-0.1.6.0 */
#define VERSION_repline "0.1.6.0"
...
#define CURRENT_COMPONENT_ID "gradualSecurity-0.1.0.0"

#define CURRENT_PACKAGE_KEY "gradualSecurity-0.1.0.0"
